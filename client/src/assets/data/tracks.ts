...
export const TRACKS: Track[] = [
  ...
  { id: 'focus-004', title: '2 AM Debug Loop',            category: 'focus', isPro: false,  url: `${BASE}/focus/2-am-debug-loop.mp3` },
  { id: 'focus-028', title: 'Terminal Rain',              category: 'focus', isPro: false,  url: `${BASE}/focus/terminal-rain.mp3` },
  { id: 'focus-036', title: 'Sunset Offbeat',             category: 'focus', isPro: false,  url: `${BASE}/focus/sunset-offbeat.mp3` },
  { id: 'focus-045', title: 'Midnight Amber Room',        category: 'focus', isPro: false,  url: `${BASE}/focus/midnight-amber-room.mp3` },
  ...
  { id: 'nature-004', title: 'A Taste of Spring',         category: 'nature', isPro: false,  url: `${BASE}/nature/a-taste-of-spring.mp3` },
  { id: 'nature-005', title: 'After School Rain',         category: 'nature', isPro: false,  url: `${BASE}/nature/after-school-rain.mp3` },
  { id: 'nature-026', title: 'Tide Stained Polaroids',    category: 'nature', isPro: false,  url: `${BASE}/nature/tide-stained-polaroids.mp3` },
  { id: 'nature-031', title: 'Misty Steam Quiet Dreams',  category: 'nature', isPro: false,  url: `${BASE}/nature/misty-steam-quiet-dreams.mp3` },
  ...
  { id: 'ambient-021', title: 'Warm Constellations',      category: 'ambient', isPro: false,  url: `${BASE}/ambient/warm-constellations.mp3` },
  { id: 'ambient-020', title: 'Underwater Dreamscape',    category: 'ambient', isPro: false,  url: `${BASE}/ambient/underwater-dreamscape.mp3` },
  { id: 'ambient-010', title: 'Ghosts on the Hillside',   category: 'ambient', isPro: false,  url: `${BASE}/ambient/ghosts-on-the-hillside.mp3` },
  { id: 'ambient-022', title: 'Cafe Da Tarde',            category: 'ambient', isPro: false,  url: `${BASE}/ambient/cafe-da-tarde.mp3` },
